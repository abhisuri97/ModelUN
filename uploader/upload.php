...
else
{
	...
	{
		if (empty($_POST['delegate-name']) || empty($_POST['country']) || $_POST['school_name']==0)
	    {
	        echo 'You did not complete all the fields. Please <b><a href="committee.php?id='.$_GET['id'].'">return to form</a></b> and do so.';
	    }
	    else 
	    {
			 	...
			 	$sql = "INSERT INTO 
					...
					if($result)
					{
						echo 'Thank you. You have successfully assigned your delegate to the committee. Go back to the <a href="committee.php?id='.$_SESSION['user_restrict'] .'"> home </a> page.';
					}
